# Westfield International School — Sublex Chat demo site
...
1. Repository:
   `https://github.com/nfamaraceesay2018-svg/sublex-demo3-school.git`
...
3. Install path: leave it empty, so the files land in the document root of
   **this subdomain**. Check you are on the `demo3.sublexchat.com` entry and
...
or use the SSH URL `git@github.com:nfamaraceesay2018-svg/sublex-demo3-school.git` with the
...
`demo-sites/site3-school.mjs` in the Sublex Chat launch folder, with the shared layout
